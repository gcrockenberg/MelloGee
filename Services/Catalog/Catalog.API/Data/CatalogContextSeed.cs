...
public class CatalogContextSeed
{
    public async Task SeedAsync(CatalogContext context, IWebHostEnvironment env, IOptions<CatalogSettings> settings, ILogger<CatalogContextSeed>? logger)
    {
        ...
        await policy.ExecuteAsync(async () =>
        {
            ...
            {
                IEnumerable<CatalogItem> catalogItems = useCustomizationData
    ...
    public static IEnumerable<CatalogItem> GetPreconfiguredItems()
    {
        return new List<CatalogItem>()
        {
            ...
            new() { CatalogTypeId = 5, CatalogBrandId = 6, AvailableStock = 100, Description = "Your perfect pack for everyday use and walks in the forest. Stash your laptop (up to 15 inches) in the padded sleeve, your everyday", Name = "Fjallraven - Foldsack No. 1 Backpack", Price = 109.95M, PictureFileName = "15.png" },
            ...
            new() { CatalogTypeId = 6, CatalogBrandId = 8, AvailableStock = 100, Description = "From our Legends Collection, the Naga was inspired by the mythical water dragon that protects the ocean's pearl. Wear facing inward to be bestowed with love and abundance, or outward for protection.", Name = "Naga Gold & Silver Dragon Station Chain Bracelet", Price = 695M, PictureFileName = "19.png" },
            ...
            new() { CatalogTypeId = 6, CatalogBrandId = 8, AvailableStock = 100, Description = "Rose Gold Plated Double Flared Tunnel Plug Earrings. Made of 316L Stainless Steel", Name = "Pierced Owl Rose Gold Plated Stainless Steel", Price = 10.99M, PictureFileName = "22.png" },
            ...
            new() { CatalogTypeId = 8, CatalogBrandId = 16, AvailableStock = 100, Description = "100% POLYURETHANE(shell) 100% POLYESTER(lining) 75% POLYESTER 25% COTTON (SWEATER), Faux leather material for style and comfort / 2 pockets of front, 2-For-One Hooded denim style faux leather jacket, Button detail on waist / Detail stitching at sides, HAND WASH ONLY / DO NOT BLEACH / LINE DRY / DO NOT IRON", Name = "Women's Hooded Faux Leather Moto Biker Jacket", Price = 29.95M, PictureFileName = "30.png" },
            new() { CatalogTypeId = 8, CatalogBrandId = 16, AvailableStock = 100, Description = "Lightweight perfet for trip or casual wear---Long sleeve with hooded, adjustable drawstring waist design. Button and zipper front closure raincoat, fully stripes Lined and The Raincoat has 2 side pockets are a good size to hold all kinds of things, it covers the hips, and the hood is generous but doesn't overdo it.Attached Cotton Lined Hood with Adjustable Drawstrings give it a real styled look.", Name = "Rain Jacket Women Windbreaker Striped Climbing", Price = 39.99M, PictureFileName = "31.png" },
